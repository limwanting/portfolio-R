...
To get a quick overview of how the data looks like, let's take a look at the graph of year 1996.
...
Next, I will explore two approaches to judge whether the unofficial end of summer has gotten later over the years.
...
Next, using the CUSUM approach to determine an end-summer-date for the years. I will use a spreadsheet to calculate the dates, and the details are in the attached spreadsheet.
...
Based on approach 1, it can't be concluded that the end of summer has goten later over the years. Let's try approach 2 and see what we get.
...
Next, I will use CUSUM to determine an end-summer-date for the years, which is where the "dip" in the data happens. I will use a spreadsheet to calculate the dates, and the details are in the attached spreadsheet.
